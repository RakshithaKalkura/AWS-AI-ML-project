...
def get_input_args():
    ...
    parser.add_argument('--arch',type=str, default = 'vgg',help='cnn model architecture - AlexNet,resnet,vgg(default)')
    parser.add_argument('--dogfile', type=str,default = 'dognames.txt', help='path to the text file containing dog breads names' )
